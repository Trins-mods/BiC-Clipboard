...
public final class ClipboardReadOnlyRenderer {
    private static final ResourceLocation BACKGROUND = new ResourceLocation(BCClipboard.ID, "textures/gui/clipboard_block.png");
    static final ResourceLocation CHECK_TEXTURE = new ResourceLocation(BCClipboard.ID,"textures/gui/check.png");
    static final ResourceLocation X_TEXTURE = new ResourceLocation(BCClipboard.ID,"textures/gui/x.png");
